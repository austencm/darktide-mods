...
local loc = {
    ...
    default_chat_color = {
        en = "Default Chat Color",
    },
    default_chat_color_desc = {
        en = "Color applied to messages you type into the in-game chat input box. All players see this color. Does not affect preset hotkey messages or auto-event messages — only what you type and send. Names from quick_chat_colors.lua.",
    },
    cycle_chat_color_hotkey = {
        en = "Cycle Chat Color (forward)",
    },
    cycle_chat_color_hotkey_desc = {
        en = "Hotkey to cycle forward through chat colors (including 'None'). The current color shows live in the preview row above the chat input box.",
    },
    cycle_chat_color_backward_hotkey = {
        en = "Cycle Chat Color (backward)",
    },
    cycle_chat_color_backward_hotkey_desc = {
        en = "Hotkey to cycle backward through chat colors (including 'None'). Pairs with the forward cycle for two-direction control.",
    },
    none = {
        en = "None",
        ja = "なし",
    ...
    probe_icons_hotkey = {
        en = "Probe Icon Glyphs",
    },
    probe_icons_hotkey_desc = {
        en = "Dumps the U+E000..U+E1FF Private Use Area codepoints to local chat so you can identify which Darktide font icons render at which codepoint.",
    },
    list_icons_hotkey = {
        en = "List Named Icons",
    },
    list_icons_hotkey_desc = {
        en = "Dumps every named icon from quick_chat_icons.lua to local chat, grouped by section, with its name beside the rendered glyph.",
    },
    list_colors_hotkey = {
        en = "List Named Colors",
    },
    list_colors_hotkey_desc = {
        en = "Dumps every named color from quick_chat_colors.lua to local chat with a sample sentence wrapped in that color, for previewing the palette in-game.",
    },
}
